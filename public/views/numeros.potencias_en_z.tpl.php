<ol class="breadcrumb">
    ...
    <li class="active">Potencias en Z</li>
</ol>

<div class="jumbotron">
    <div class="container">
        <h1>Potencias en Z</h1>
    </div>
</div>
    ...
    <div class="col-sm-6">
        <div class="panel panel-primary">
            ...
            <div class="list-group">
                <a class="list-group-item" href="/textos/numeros/5_potencias_en_z/potencias_en_z_ver1.pdf" download>Apunte 1</a>
            </div>
        </div>
    </div>
    <div class="col-sm-6">
