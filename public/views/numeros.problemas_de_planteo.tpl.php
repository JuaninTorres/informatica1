<ol class="breadcrumb">
    ...
    <li class="active">Problemas de Planteo</li>
</ol>
    ...
    <div class="col-sm-6">
        <div class="panel panel-primary">
            ...
            <div class="list-group">
                <a class="list-group-item" href="/textos/numeros/4_problemas_de_planteo/problemas_de_planteo_ver1.pdf" download>Apunte 1</a>
            </div>
        </div>
    </div>
    <div class="col-sm-6">
