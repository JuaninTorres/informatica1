<ol class="breadcrumb">
    ...
    <li class="active">Operatoria en Q</li>
</ol>

<div class="jumbotron">
    <div class="container">
        <h1>Operatoria en Q</h1>
    </div>
</div>
    ...
    <div class="col-sm-6">
        <div class="panel panel-primary">
            ...
            <div class="list-group">
                <a class="list-group-item" href="/textos/numeros/3_operatoria_en_q/operatoria_en_q_ver1.pdf" download>Apunte 1</a>
            </div>
        </div>
    </div>
    <div class="col-sm-6">
